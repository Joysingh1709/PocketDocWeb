...
@Component({
  selector: 'app-chat-doc-body',
  templateUrl: './chat-doc-body.component.html',
  styleUrls: ['./chat-doc-body.component.css']
})
export class ChatDocBodyComponent implements OnInit {
  ...
  addClassToMessages(i): string {
    ...
    if (i > 0 && i < this.chatMessagesToPassed.length - 1) {
      ...
      // incomming message
      if (this.chatMessagesToPassed[i].senderId !== this.chatDataPassed.doctorId) {
        if (this.chatMessagesToPassed[i - 1].senderId !== this.chatDataPassed.doctorId && this.chatMessagesToPassed[i + 1].senderId !== this.chatDataPassed.doctorId) {
          return 'incoming-message incoming-message-between';
        } else if (this.chatMessagesToPassed[i - 1].senderId !== this.chatDataPassed.doctorId && this.chatMessagesToPassed[i + 1].senderId === this.chatDataPassed.doctorId) {
      ...
      if (this.chatMessagesToPassed[i].senderId !== this.chatDataPassed.doctorId) {
        return 'incoming-message incoming-message-new';
      } else if (this.chatMessagesToPassed[i].senderId === this.chatDataPassed.doctorId) {
        return 'outgoing-message outgoing-message-new';
      }
    }
